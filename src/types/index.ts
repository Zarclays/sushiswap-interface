...
import { Currency, CurrencyAmount, Token, Trade as LegacyTrade, TradeType } from '@zarclays/zswap-core-sdk'
import { PoolState, Trade } from '@zarclays/zswap-trident-sdk'
